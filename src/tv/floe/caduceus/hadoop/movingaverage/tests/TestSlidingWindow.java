...
public class TestSlidingWindow {
	...
	public void testPointOrdering() {
		...
		SlidingWindow window = new SlidingWindow(2 * day_in_ms, day_in_ms,
				day_in_ms);
		...
		SlidingWindow window_ex = new SlidingWindow(2 * day_in_ms, day_in_ms,
				day_in_ms);
		...
		assertEquals("exception window test", 1,
				window_ex.GetNumberPointsInWindow());
	...
	public void testWindowFull() {
		...
		assertEquals("window size post slide", 86400000,
				window.GetWindowDelta());
	...
	public void testSimpleMovingAverage() {
		...
		int iWindowSizeInDays = 2; // this.configuration.getInt("tv.floe.examples.mr.sax.windowSize",
									// 30 );
		int iWindowStepSizeInDays = 1; // this.configuration.getInt("tv.floe.examples.mr.sax.windowStepSize",
										// 1 );
